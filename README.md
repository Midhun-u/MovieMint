...
## Technologies
 ...
 - **Backend:**
    Fastify, Express js, Hono js, Node js, Bun js, Typescript, Sequelize, Mongoose, Bullmq (For background tasks), Zod (For validation), Multer (For multiformdata data), Nodemailer (For mail service), JWT, Bcrypt
...
![Verify email page](./assets/verify-email-page.png)
![Home page](./assets/home-page.png)
![Movie Categories](./assets/movie-categories-page.png)
![Dark theme](./assets/dark-theme.png)
![Movie Details page](./assets/movie-details-page.png)
![Movie Crew page](./assets/movie-crew-page.png)
![Movie Trailer](./assets/movie-trailer.png)
![All movies page](./assets/all-movies-page.png)
![Movie ratings page](./assets/movie-ratings-page.png)
![Movie show page](./assets/movies-show-page.png)
![Theater seat Layout](./assets/theater-seat-layout-page.png)
![Bookings page](./assets/bookings-page.png)
![Notification page](./assets/notification-page.png)
![Saved list page](./assets/saved-list-page.png)
