...
import { updateNotificationController } from "../controllers/updateNotification.controller";
...
// Route for updating notification
notificationRouter.patch("/update-notification/:id", updateNotificationController)