      ...
      <p
        className={
          theaterDetails.status === "AVAILABLE"
            ...
            : theaterDetails.status === "NOT_AVAILABLE"
              ? style["not-show-status"]
