...
import { X as CloseIcon, UserIcon, UploadIcon } from "lucide-react";
    ...
    if (event.target.files?.length) {
      ...
      if (file.size > fileSize)
        return toastContext?.triggerToastMessage(
          "File size is exceeded the limit",
          "ERROR",
        );
        ...
        <div className={style["form-section"]}>
          <div className={style.form}>
            ...
            <div className={style["image-section"]}>
              <FormLabel title="Actor Image" />
              <div
                className={
                  preview || selectedValue
                    ? style["preview-image-container"]
              ...
              >
                {preview || selectedValue?.preview ? (
                  <div className={style["preview-image"]}>
                    <img
                      src={
                        selectedValue?.preview ? selectedValue.preview : preview
                      }
                    />
                  </div>
                ) : (
