...
import { approveTheaterApi, deleteTheaterApi, getTheaterDetailsApi } from '../../api/theater'
...
const TheaterDetails = () => {
    ...
    const handleGetTheaterDetails = async (theaterId: string) => {

        const result = await getTheaterDetailsApi(theaterId)
        if (result.success) {
    ...
    useEffect(() => {
        ...
        handleGetTheaterDetails(theaterId)
        ...
        <div className={style.container}>
            ...
            {/* Details */}
            {
                theaterDetails
                    ?
                    <>
                        <Suspense fallback={<Spinner color={theme === "dark" ? "white" : "black"} size={25} />}>
