...
interface ProfilePageProps{
    setSelectePageName: Dispatch<SetStateAction<string>>
}
...
const ProfilePage = ({
    ...
    return (
        ...
        <div className="max-[700px]:p-0 p-5 mt-3 flex flex-col gap-5 max-h-125 overflow-scroll">
            <div className="flex gap-1.25">
                <BackIcon
                    className="max-[700px]:block hidden cursor-pointer"
                    onClick={() => setSelectePageName("")}
                />
                <div className="">
