...
export const updateUserDetailsApi = handleError(async (updateData: object, authToken: string) => {

    const result = await fetchInstance(AUTH_BASE_URL, "/update-user", "PATCH", updateData, "json", authToken)
    return result
